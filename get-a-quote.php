...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <!-- Add this script inside the body or as an external JS file -->
<script>
  document.addEventListener("DOMContentLoaded", () => {
    ...
    button.addEventListener("click", (event) => {
      ...
      alert("Thank you for requesting a quote! Your information has been received.");
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <ul>
          ...
          <li><a class="get-a-quot active" href="get-a-quote.php">Get a Quote</a></li>
        </ul>
      </nav><!-- .navbar -->
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Get a Quote</h2>
              <p class="text-secondary">Elevate Your Logistics with Our Expertise

                Get a personalized quote and discover how our logistics solutions can streamline your operations.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-7">
            <form action="forms/quote.php" method="post" class="php-email-form">
              <h3>Get a quote</h3>
              <p class="text-light">Reach out to us today to get a personalized quote and discover how our comprehensive logistics services can take your business to new heights.</p>
              <div class="row gy-4">
