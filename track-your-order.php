    ...
    <section class="sample-page">
      <div class="container" data-aos="fade-up">
        ...
        <div id="user-info-form">
          ...
          <form id="user-form">
            ...
            <div class="mb-3">
              ...
              <input type="text" id="email" class="form-control" placeholder="Enter phone or email" required>
              <div class="form-text text-muted">Invoice will be sent to the provided Email</div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              <label for="cost" class="form-label">Total Cost (KES):</label>
              <input type="text" id="cost" class="form-control" readonly>
              <div class="form-text text-muted">Cost will be calculated and charged upon delivery.</div>
            </div>
            <button type="submit" class="btn btn-primary">Generate Tracking ID / Invoice</button>
          </form>
        </div>
        ...
        <div id="tracking-form" style="display: none;">
          ...
          <p>Invoice has been Send to you Email</p>
...
<script>
  ...
  weightInput.addEventListener('input', () => {
    ...
    const costPerKg = 167; // Adjust as needed
  ...
  document.getElementById("user-form").addEventListener("submit", function(event) {
    ...
    emailjs.send("service_uwz7y3a", "template_yhkdbcg", {
      generatedTrackingId: generatedTrackingId,
      image_url: "./assets/img/logistics-service.jpg",
      weight: weight + " kg",
      cost: {
        shipping: shipping.toFixed(2), // ensures it's a string like "100.00"
        tax: tax.toFixed(2),
  ...
  document.getElementById("track-btn").addEventListener("click", async function() {
    ...
    if (enteredTrackingId === generatedTrackingId) {
      ...
      emailjs.send("service_uwz7y3a","template_ts5t7dl",{
        name: name,
        email: email,
      });
