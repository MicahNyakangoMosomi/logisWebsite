        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Pricing</h2>
              <p class="text-secondary">At Muhidin Logistics, we believe in offering flexible pricing plans designed to meet the needs of every customer. Whether you're just starting out or managing a large-scale operation, our subscription options provide the right tools and support at every stage of your journey.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row gy-4 pricing-item" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-3 d-flex align-items-center justify-content-center">
            <ul>
              ...
              <li class="na"><i class="bi bi-x"></i><span>Community Support</span></li>
